...
--
-- Host: localhost    Database: db_lpk_riset
-- ------------------------------------------------------
...
INSERT INTO `com_menu` VALUES (2,'0','Master Data','','#',20,'0','1','1','ti-harddrives','1911130001','admin','2019-11-22 04:05:43'),(3,'2','User','menu user','master/user',1,'0','1','1','','1911130001','admin','2019-11-22 04:06:47'),(4,'0','Sistem','','#',21,'0','1','1','ti-settings','1911130001','admin','2019-11-22 04:06:08'),(5,'4','Menu Navigasi','navigasi','sistem/navigation',1,'0','1','1',NULL,'1911130001','admin','2019-11-21 17:30:53'),(6,'4','Role','master role','sistem/role',3,'0','1','1',NULL,'1911130001','admin','2019-11-21 17:31:23'),(7,'4','Group','group role','sistem/group',2,'0','1','1','','1911130001','admin','2019-11-27 02:30:36'),(8,'0','Logout','logout','sistem/login/logout',100,'0','1','1','ti-close','1911130001','admin','2019-11-22 04:06:36'),(9,'0','Lihat Beranda','Link to beranda','client/beranda',99,'0','1','1','ti-home','1911130001','admin','2019-11-27 04:52:38'),(10,'0','Dashboard','','#',1,'0','1','1','ti-home','1911130001','admin','2019-11-22 04:54:22'),(11,'10','Dashboard','dashboard content','welcome',1,'0','1','1','','1911130001','admin','2019-11-22 04:58:30'),(12,'4','Permission','Hak akses user','sistem/permission',4,'0','1','1','','1911130001','admin','2019-11-22 08:03:16'),(13,'0','Beranda','Untuk menu front client','client/beranda',1,'1','1','1','','1911130001','admin','2019-11-27 04:52:17'),(14,'0','About','Untuk menu front client','client/about',2,'1','1','1','','1911130001','admin','2019-11-27 04:52:29'),(15,'0','Login','Login ke portal admin','welcome',3,'1','1','1','','1911130001','admin','2019-11-27 04:57:28'),(16,'0','Halaman Client','Untuk halaman client','#',2,'0','1','1','ti-layers-alt','1911130001','admin','2019-11-27 09:46:42'),(17,'16','Atur Beranda','Beranda untuk halaman depan','setclient/beranda',1,'0','1','0','','1911130001','admin','2019-11-27 09:57:16'),(18,'16','Atur Kontak','Atur data kontak di halaman depan','setclient/contact',2,'0','1','1','','1911130001','admin','2019-11-27 09:58:11');
...
INSERT INTO `com_role_menu` VALUES ('1','10','1111'),('2','10','1111'),('1','11','1111'),('2','11','1111'),('1','12','1111'),('1','16','1111'),('1','17','1111'),('1','18','1111'),('1','2','1111'),('1','3','1111'),('1','4','1111'),('1','5','1111'),('1','6','1111'),('1','7','1111'),('1','8','1111'),('2','8','1111'),('1','9','1111');
...
--
-- Dumping routines for database 'db_lpk_riset'
--
...
-- Dump completed on 2019-11-27 16:55:34
